...
## Table des matières
1. [Configuration d'un espace serveur](#configuration-dun-espace-serveur)
   - [Qu'est-ce qu'un SysAdmin ?](#quest-ce-quun-sysadmin)
   - [Types de services Cloud](#types-de-services-cloud)
   - [Préparation avant connexion au serveur](#préparation-avant-connexion-au-serveur)
   - [Création d'un serveur virtuel](#création-dun-serveur-virtuel)
   - [Connexion SSH au serveur](#connexion-ssh-au-serveur)
   - [Création d'un utilisateur avec privilèges limités](#création-dun-utilisateur-avec-privilèges-limités)
   - [Récapitulatif des étapes clés](#récapitulatif-des-étapes-clés)

2. [Téléchargement de l'application sur le serveur distant](#téléchargement-de-lapplication-sur-le-serveur-distant)
   - [Objectifs du chapitre](#objectifs-du-chapitre)
   - [Installation des librairies nécessaires](#installation-des-librairies-necessaires)
   - [Téléchargement de l'application](#téléchargement-de-lapplication)
   ...
   - [Modification des paramètres Django](#modification-des-paramètres-django)
   - [Gestion des fichiers statiques](#gestion-des-fichiers-statiques)
   - [Migration et chargement des données](#migration-et-chargement-des-données)
...
## Préparation avant connexion au serveur
